...
def create_tf_example(filename):
  ...
  print('working')  
  image_path='/home/jai/Downloads/Datasets/Taylor Swift/test/' + filename
  
  xml = re.sub('\.jpg$', '', filename)        
  
  label_path='/home/jai/Downloads/Datasets/Taylor Swift/test_label/' + xml + '.xml' 
...
def main(_):
  writer = tf.python_io.TFRecordWriter('/home/jai/Downloads/test.record')

  for filename in os.listdir('/home/jai/Downloads/Datasets/Taylor Swift/test/'):
